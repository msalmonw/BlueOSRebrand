...
export default Vue.extend({
      ...
      return [
        {
          ...
          header: {
            title: 'Welcome to Edron Underwater!',
          },
          content: `We are happy to have you navigating with us! Edron Underwater provides the
        ...
        {
          target: '#tour-center-hook',
          content: 'Connect Edron Underwater to the internet to enable online functionalities.',
        ...
        },
        {
          ...
          content: `Here you can find all kinds of tools to improve your Edron Underwater experience.
  ...
  watch: {
    $route() {
      ...
      const project_name = process.env.PROJECT_NAME ?? 'Edron Underwater'
